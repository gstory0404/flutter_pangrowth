package com.gstory.flutter_pangrowth.video.view.single_news_card
...
internal class VideoNewsSingleCardView(
    ...
    private val TAG = VideoNewsSingleCardView::class.java.simpleName
    ...
    private fun loadVideoSingleCard() {
        ...
        VideoHolder.INSTANCE.loadVideoSingleCard4News(params, object : IDPWidgetFactory.Callback {
