package com.gstory.flutter_pangrowth.video.view.bubble
...
import com.gstory.flutter_pangrowth.VideoHolder
import com.gstory.flutter_pangrowth.utils.UIUtils
import io.flutter.plugin.common.BinaryMessenger
import io.flutter.plugin.platform.PlatformView

/**
 * @Author: gstory
 * @CreateDate: 2021/12/15 12:23 下午
 * @Description: 视频组件-气泡
 */

internal class VideoBubbleView(
    ...
    private val TAG = VideoBubbleView::class.java.simpleName
    ...
    private var title: String = params["title"] as String

    private var mBubbleElement: IDPElement? = null
    ...
    private fun loadBubble() {
        VideoHolder.INSTANCE.loadBubble(DPWidgetBubbleParams.obtain()
                .componentPosition(DPComponentPosition.HOME)
                .backgroundColor(-0x660a0a0b) // 背景颜色
                //                .iconDrawable(R.drawable.ic_launcher) // icon标志
                .iconHeight(16) // icon高度
                .iconWidth(16) // icon宽度
                .showIcon(true) // 是否展示icon
                .radius(floatArrayOf(8f, 8f, 0f, 0f, 0f, 0f, 8f, 8f))
                .titleText(title)
                .titleTextColor(-0xddddde) // 标题文字颜色
                .titleTextSize(14f) // 标题文字大小
                .titleTypeface(Typeface.DEFAULT) // 标题文字字体
                .listener(object : IDPBubbleListener() {
            ...
            override fun onSuccess(data: IDPElement) {
                ...
                mBubbleElement = data
                val view: View? = mBubbleElement?.view
                if (view != null) {
                    mContainer.addView(view)
                    mBubbleElement?.reportShow()
                }
            }
        })
    }
