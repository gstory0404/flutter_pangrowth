...
class NovelRecommendFeedPage extends StatefulWidget {
  const NovelRecommendFeedPage({Key? key}) : super(key: key);

  @override
  _NovelRecommendV1State createState() => _NovelRecommendV1State();
}

class _NovelRecommendV1State extends State<NovelRecommendFeedPage> {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Feed推荐书列表"),
        centerTitle: true,
      ),
      body: FutureBuilder<NovelEntity>(
        future: FlutterPangrowth.getNovelRecommendFeed(
          size: 10,
        ),
